console.log("Welcome to Musicals");
...
//update cuurent song time
function songTimeUpdate(){
    if(track.duration){
        let currmins = Math.floor(track.currentTime/60);
        let currsec = Math.floor(track.currentTime-currmins*60);
        let durmins = Math.floor(track.duration/60);
        let dursec = Math.floor(track.duration-durmins*60);
